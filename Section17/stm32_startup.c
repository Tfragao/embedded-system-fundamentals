...
void Reset_handler(void)  
{
	...
	{
		*pDst++ = *pSrc++; //Copying from text .data in Flash to .data in Sram
	}
   ...
   //call init function of std library (for example if you are using printf in your code) 
	__libc_init_array();
  //3. call main()
  main();
...
uint32_t vectors[] __attribute__((section(".isr_vector"))) = {
	STACK_START, 
	(uint32_t)&Reset_handler,   //given the address of the reset handler using function pointer.
